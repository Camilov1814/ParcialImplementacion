...
func (s *Seeder) SeedUsers() error {
	...
	users := []models.User{
		...
		// Network Admins
		{
			...
			Email:    "alice@network.admin",
			Password: s.hashPassword("NetworkAlice123!"),
			Role:     models.RoleNetworkAdmin,
			Status:   models.StatusActive,
		},
		{
			Username: "netadmin_bob",
			Email:    "bob@network.admin",
			Password: s.hashPassword("NetworkBob123!"),
			Role:     models.RoleNetworkAdmin,
			Status:   models.StatusCaptured,
		},
		{
			Username: "netadmin_charlie",
			Email:    "charlie@network.admin",
			Password: s.hashPassword("NetworkCharlie123!"),
			Role:     models.RoleNetworkAdmin,
			Status:   models.StatusActive,
		},
		{
			Username: "netadmin_diana",
			Email:    "diana@network.admin",
			Password: s.hashPassword("NetworkDiana123!"),
			Role:     models.RoleNetworkAdmin,
			Status:   models.StatusCaptured,
		},
		{
			Username: "netadmin_eve",
			Email:    "eve@network.admin",
			Password: s.hashPassword("NetworkEve123!"),
			Role:     models.RoleNetworkAdmin,
			Status:   models.StatusActive,
		},
	}
